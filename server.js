...
router.get("/datavolley/:fedCode/:gameId/update-score",function(req,res) {
    var match = DataVolley.Match.getInstance(req.params.fedCode, req.params.gameId)

    match.getGameInfo(true).then ( function (data) {
...
router.get("/datavolley/:fedCode/:gameId/game-info",function(req,res) {
    ...
    match.getGameInfo().then ( function (data) {
